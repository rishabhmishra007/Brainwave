...
const Hero = () => {
    ...
    return (
        <Section className='pt-[12rem] -mt-[5.25rem] overflow-hidden' crosses crossesOffset="lg:translate-y-[5.7rem]" customPaddings id='hero' >
                                    ...
                                    <ul className='hidden absolute -left-[5.5rem] bottom-[7.5rem] px-1 py-1 bg-n-9/40 backdrop-blur border border-n-1/10 rounded-2xl xl:flex'>
                                        {heroIcons.map((item, index) => (
                                            <li className='p-5' key={index}>
                                                <img src={item} width={24} height={25} alt="icons" />
                                            </li>
                                        ))}
                                    </ul>
                                </ScrollParallax>
